...
@Component({
  ...
  imports: [RouterOutlet, MenubarModule, ButtonModule, ToastModule, ConfirmDialogModule, MessagesIconComponent, NotificationsBellComponent, ThemeToggleComponent, UserMenuComponent, RouterLink, QuickSearchComponent, TooltipModule],
